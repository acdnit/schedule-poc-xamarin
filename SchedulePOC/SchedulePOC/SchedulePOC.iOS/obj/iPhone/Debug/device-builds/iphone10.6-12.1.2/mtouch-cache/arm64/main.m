...
extern void *mono_aot_module_SchedulePOC_iOS_info;
...
extern void *mono_aot_module_SchedulePOC_info;
...
extern void *mono_aot_module_Microsoft_Practices_Unity_info;
...
{
	mono_aot_register_module (mono_aot_module_SchedulePOC_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_SchedulePOC_info);
	...
	mono_aot_register_module (mono_aot_module_Microsoft_Practices_Unity_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "SchedulePOC.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
